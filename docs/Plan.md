...
**Ожидаемый результат:** 
Оплата проходит. Выведено сообщение "Успешно. Операция одобрена банком."
...
Аналогично протестировать все те же позитивные (1-2) и негативные сценарии (1-21) для кнопки "Купить в кредит".
